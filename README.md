...
Open `index.html` in a browser to see the design system reference implementation.

All styles are defined in `design-system.css` using CSS custom properties for easy theming and maintenance.
